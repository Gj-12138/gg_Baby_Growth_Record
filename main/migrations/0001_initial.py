    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='media/thumb/%Y/%m', verbose_name='缩略图')),
                ('description', models.CharField(blank=True, max_length=200, verbose_name='描述')),
                ('location', models.CharField(blank=True, max_length=200, verbose_name='拍摄地点')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('daily', '日常记录'), ('health', '健康记录'), ('development', '发育记录'), ('feeding', '喂养记录'), ('sleep', '睡眠记录'), ('other', '其他')], default='daily', max_length=20, verbose_name='分类')),
                ('record_type', models.CharField(choices=[('text', '文字'), ('voice', '语音')], default='text', max_length=20, verbose_name='类型')),
                ('voice', models.FileField(blank=True, null=True, upload_to='voice/%Y/%m', verbose_name='语音文件')),
                ('voice_duration', models.PositiveIntegerField(default=0, verbose_name='语音时长(秒)')),
                ('record_date', models.DateField(db_index=True, default=django.utils.timezone.now, verbose_name='记录日期')),
